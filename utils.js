...
module.exports.createApp = function () {
    ...
    app.use(session({
        ...
        duration: 24 * 60 * 1000,
        activeDuration: 1 * 10 * 1000, // if expiresIn < activeDuration, the session will be extended by activeDuration milliseconds
        cookie: {
        path: '/', // cookie will only be sent to requests under '/api' 
        maxAge: 5 * 10 * 1000, // duration of the cookie in milliseconds, defaults to duration above 
